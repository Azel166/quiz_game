...
public class Quiz implements ActionListener {
	...
	String[][] options = { { "Sun Micro System", "StarBucks", "Microsoft", "Alphabet" },
			{ "1972", "1989", "1492", "1996" }, { "Apple", "Latte", "Oak", "Koffing" },
			{ "Steve Jobs", "Bill Gates", "James Gosling", "Mark Zuckerburg" } };

	char[] answers = { 'A', 'D', 'C', 'C' };
	...
	public Quiz() {
		...
		field.setFont(new Font("Ink Free", Font.BOLD, 30));
